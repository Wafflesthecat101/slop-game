...
Bumped to Bevy **0.19.0** (with matching `bevy_kira_audio` 0.26 / `bevy_asset_loader` 0.27) — the latest stable release at the time of writing — from the template's pinned 0.18.0.
